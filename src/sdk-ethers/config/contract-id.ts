const MARKET_NAME = 'ExtraXLending'
...
export const EXTRA_X_ACCOUNT_FACTORY = `ExtraXAccountFactory`
export const WRAPPED_TOKEN_GATEWAY_V3 = `WrappedTokenGatewayV3`
export const WALLET_BALANCE_PROVIDER = 'WalletBalanceProvider'
export const UI_INCENTIVE_DATA_PROVIDER_V3 = 'UiIncentiveDataProviderV3'
export const UI_POOL_DATA_PROVIDER_V3 = 'UiPoolDataProviderV3'
export const PARA_SWAP_LIQUIDITY_SWAP_ADAPTER = 'ParaSwapLiquiditySwapAdapter'
export const PARA_SWAP_REPAY_ADAPTER = 'ParaSwapRepayAdapter'
export const PARA_SWAP_WITHDRAW_SWAP_ADAPTER = 'ParaSwapWithdrawSwapAdapter'
