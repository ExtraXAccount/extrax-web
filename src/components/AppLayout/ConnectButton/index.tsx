            ...
            {(() => {
              ...
              return (
                <div style={{ display: 'flex', gap: 8 }}>
                  ...
                  <button onClick={openAccountModal} type="button" className='connect-button-display'>
