...
import styles from './LendListProperty1Default.module.css'

export interface ILendListProperty1DefaultProps {
  className?: string
}

export const LendListProperty1Default = ({
  className,
  ...props
}: ILendListProperty1DefaultProps): JSX.Element => {
  return (
    <div className={styles.lendListProperty1Default + ' ' + className}>
