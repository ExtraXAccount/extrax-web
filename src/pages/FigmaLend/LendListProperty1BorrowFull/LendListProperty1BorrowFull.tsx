...
import styles from './LendListProperty1BorrowFull.module.css'

export interface ILendListProperty1BorrowFullProps {
  className?: string
}

export const LendListProperty1BorrowFull = ({
  className,
  ...props
}: ILendListProperty1BorrowFullProps): JSX.Element => {
  return (
    <div className={styles.lendListProperty1BorrowFull + ' ' + className}>
