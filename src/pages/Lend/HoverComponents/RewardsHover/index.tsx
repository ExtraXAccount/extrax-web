...
export default function RewardsHover(props: {
  ...
  const content = (
    <section
      className={cx('rewards-hover', 'hover-content', `rewards-hover-${type}`)}
    ...
    >
      ...
      <div className="rewards-hover-content">
        <section className="rewards-hover-content-list">
          {rewards.map((i) => {
            return (
              <div className="rewards-hover-content-list-item" key={i.token}>
                <section className="rewards-hover-content-list-item-info">
                  <b>{i.token} REWARD</b>
                  <p className="text-sm-2">{i.weekAmount} WEEKLY</p>
                </section>
                <section className="rewards-hover-content-list-item-apy">
                  {i.apy}%
                </section>
              </div>
            )
