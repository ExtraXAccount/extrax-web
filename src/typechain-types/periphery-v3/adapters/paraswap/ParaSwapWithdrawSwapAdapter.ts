...
export interface ParaSwapWithdrawSwapAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADDRESSES_PROVIDER"
      | "AUGUSTUS_REGISTRY"
  ...
  getEvent(
    nameOrSignatureOrTopic: "Bought" | "OwnershipTransferred" | "Swapped"
  ): EventFragment;
...
export interface ParaSwapWithdrawSwapAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): ParaSwapWithdrawSwapAdapter;
  ...
  withdrawAndSwap: TypedContractMethod<
    [
  ...
  getFunction(
    nameOrSignature: "withdrawAndSwap"
  ): TypedContractMethod<
    [
      assetToSwapFrom: AddressLike,
      assetToSwapTo: AddressLike,
