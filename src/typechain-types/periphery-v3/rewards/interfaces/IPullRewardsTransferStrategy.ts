...
export interface IPullRewardsTransferStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "emergencyWithdrawal"
...
export interface IPullRewardsTransferStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): IPullRewardsTransferStrategy;
  ...
  getRewardsVault: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "getRewardsVault"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
