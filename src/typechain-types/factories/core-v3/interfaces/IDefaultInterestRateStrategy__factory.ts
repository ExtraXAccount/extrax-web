...
} from "../../../core-v3/interfaces/IDefaultInterestRateStrategy";
...
export class IDefaultInterestRateStrategy__factory {
  ...
  static createInterface(): IDefaultInterestRateStrategyInterface {
    return new Interface(_abi) as IDefaultInterestRateStrategyInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IDefaultInterestRateStrategy;
  }
}
