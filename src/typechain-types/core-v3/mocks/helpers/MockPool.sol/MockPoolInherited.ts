...
export interface MockPoolInheritedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADDRESSES_PROVIDER"
      | "BRIDGE_PROTOCOL_FEE"
...
export interface MockPoolInherited extends BaseContract {
  connect(runner?: ContractRunner | null): MockPoolInherited;
  ...
  setMaxNumberOfReserves: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "setMaxNumberOfReserves"
  ): TypedContractMethod<
    [newMaxNumberOfReserves: BigNumberish],
    [void],
    "nonpayable"
