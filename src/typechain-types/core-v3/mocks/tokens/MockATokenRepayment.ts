...
export interface MockATokenRepaymentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ATOKEN_REVISION"
      | "DOMAIN_SEPARATOR"
...
export namespace MockRepaymentEvent {
  export type InputTuple = [
    user: AddressLike,
    onBehalfOf: AddressLike,
    amount: BigNumberish
  ];
  export type OutputTuple = [user: string, onBehalfOf: string, amount: bigint];
  export interface OutputObject {
    user: string;
    onBehalfOf: string;
    amount: bigint;
...
export interface MockATokenRepayment extends BaseContract {
  connect(runner?: ContractRunner | null): MockATokenRepayment;
  ...
  getEvent(
    ...
    MockRepaymentEvent.InputTuple,
    MockRepaymentEvent.OutputTuple,
    MockRepaymentEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "MockRepayment(address,address,uint256)": TypedContractEvent<
      MockRepaymentEvent.InputTuple,
      MockRepaymentEvent.OutputTuple,
      MockRepaymentEvent.OutputObject
    >;
    MockRepayment: TypedContractEvent<
      MockRepaymentEvent.InputTuple,
      MockRepaymentEvent.OutputTuple,
      MockRepaymentEvent.OutputObject
    >;
