...
export interface MockReserveInterestRateStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADDRESSES_PROVIDER"
...
export interface MockReserveInterestRateStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): MockReserveInterestRateStrategy;
  ...
  setStableBorrowRate: TypedContractMethod<
    [stableBorrowRate: BigNumberish],
    [void],
    "nonpayable"
  >;

  setVariableBorrowRate: TypedContractMethod<
  ...
  ): TypedContractMethod<[liquidityRate: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setStableBorrowRate"
  ): TypedContractMethod<
    [stableBorrowRate: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setVariableBorrowRate"
  ): TypedContractMethod<
    [variableBorrowRate: BigNumberish],
    [void],
    "nonpayable"
